...
namespace DataExtractionTool.Controllers
{
    ...
    public class ReportController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("ExportReport")]
        public  FileResult ExportReport(FilterParams_DTO parameters)
        {
            SqlParameter[] inputParameter = {
            ...
            DataTable _reportData = new DataTable();
        ...
        [HttpPost]
        [Route("GetReportADO")]
        public async Task<int> GetReportADO(FilterParams_DTO parameters)
        {
            SqlParameter[] inputParameter = {
